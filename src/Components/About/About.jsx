    ...
    <Standard id="about">
      <div className="column-wrap">
        <div className="about-copy">
          ...
          <p>I've worked on larger projects requiring the building of custom APIs using Google Cloud Services, Firebase and cloud functions. I've also been responsible for implementing WCAG recommendations on website accessibility.</p>
          <p>I've not always been a web developer. In the past I've also been a graphic designer for both print and the web, and was a managing editor for a nonprofit organization. During that time I gained significant experience with Adobe Creative Suite.</p>
          <p>I enjoy learning new frameworks and technologies and finding the right mix of solutions to bring a project to life. </p>
        </div>
